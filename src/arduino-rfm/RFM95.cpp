...
/****************************************************************************************************
*  Revision History
*  30 October 2020     Zaki      Changed frequency to follow AS1
*
*
*****************************************************************************************************/
...
/****************************************************************************************************
*  Revision History
*  30 October 2020     Zaki      Change Freq to follow AS1 for Malaysia usage
*
*
*****************************************************************************************************/
void RFM_Change_Channel(unsigned char Channel)
{
    ...
    case 0x01: //Channel 1 923.400 MHz / 61.035 Hz = 15129024 = 0xE6D9C0
			...
			RFM_Write(0x08,0xC0);
      break;
		case 0x02: //Channel 2 922.200 MHz / 61.035 Hz = 15109363 = 0xE68CF3
			RFM_Write(0x06,0xE6);
			RFM_Write(0x07,0x8C);
			RFM_Write(0x08,0xF3);
      break;
		case 0x03: //Channel 3 922.400 MHz / 61.035 Hz = 15112640 = 0xE699C0
			RFM_Write(0x06,0xE6);
			RFM_Write(0x07,0x99);
			RFM_Write(0x08,0xC0);
      break;
		case 0x04: //Channel 4 922.600 MHz / 61.035 Hz = 15115917 = 0xE6A68D
			RFM_Write(0x06,0xE6);
			RFM_Write(0x07,0xA6);
			RFM_Write(0x08,0x8D);
      break;
		case 0x05: //Channel 5 922.800 MHz / 61.035 Hz = 15119193 = 0xE6B359
			RFM_Write(0x06,0xE6);
			RFM_Write(0x07,0xB3);
			RFM_Write(0x08,0x59);
      break;
		case 0x06: //Channel 6 923.000 MHz / 61.035 Hz = 15122470 = 0xE6C026
			RFM_Write(0x06,0xE6);
			RFM_Write(0x07,0xC0);
			RFM_Write(0x08,0x26);
      break;
		case 0x07: //Channel 7 922.000 MHz / 61.035 Hz = 15106086 = 0xE68026
			RFM_Write(0x06,0xE6);
			RFM_Write(0x07,0x80);
			RFM_Write(0x08,0x26);
      break;

...
class LoRaIdClass
{
    public:
        ...
        void setNwkAccessKey(char *accessKey_in);
        void setAppAccessKey(unsigned char *accessKey_in);
        void setAppAccessKey(char *accessKey_in);
        ...
        void sendToGateway(String data, unsigned char confirm); // Simplified sendToGateway
        void sendToGateway(String data); // Even more simplified sendToGateway
        String makeData(int data1, int data2, int data3, String ddata1, String ddata2, String ddata3);
        void sendToGateway(char *data, unsigned int len, unsigned char confirm);
